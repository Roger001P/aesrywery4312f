...
class Contrast_user(torch.nn.Module):
    ...
    def forward(self, z1: torch.Tensor, z2: torch.Tensor):
        sample_index = torch.randperm(int(z1.shape[0] * 1))
        z1_sample = z1[sample_index]
        z2_sample = z2[sample_index]

        h1 = self.mlp1(z1_sample)
        h2 = self.mlp2(z2_sample)
